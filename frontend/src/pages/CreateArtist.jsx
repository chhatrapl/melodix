...
function CreateArtist() {
  ...
  <div className="fixed inset-0 z-100 flex flex-col items-center justify-center bg-black/60 backdrop-blur-sm">
    ...
    {/* Message */}
    <h2 className="text-white mt-4 text-xl font-semibold">creating artist...</h2>
   ...
   onSubmit={async (e)=>{
    ...
    try {
      setIsLoading(true)
      const data = await axios.post('http://localhost:3000/api/v1/artist/createartist',formData )
   ...
   >
     ...
     <div>
                ...
                <input type="text" placeholder="Enter Artist name" name="title"
     ...
     <div>
                <label className="block text-xs font-medium uppercase tracking-wider text-zinc-500 mb-1 ml-1">Image</label>
